...
from .adaptive_engine import generate_learning_path, load_topic_graph
from .llm_service import extract_skills_with_llm
from .models import AnalyzeResponse, RequiredSkill, Skill
...
async def analyze(
    ...
    learning_path, learning_path_graph = generate_learning_path(
        topic_graph,
        topic_data,
